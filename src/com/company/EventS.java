...
abstract class Model {
    private Simulator01 simulator;
    protected void simulator(Simulator01 simulator) {this.simulator = simulator;}
    public Model() {}
...
final class Simulator01 {
    private final Model model;
    double clock;
    private final EventList events;
    public Simulator01(Model model) {
        this.model = model;
        clock = 0.0;
